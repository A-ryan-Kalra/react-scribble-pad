...
function Canvas() {
    ...
    const [bgColor, setBgColor] = useState({ openPalette: false, color: "" });
    ...
    function customCursorColor(event) {
        setShowStickerDetails((prev) => ({
            ...prev,
            ...
            cursor: tools.canvasText ? "text" : "",
                    ...
                    width: tools.showScreen ? "300px" : "350px",
                                ...
                                setTools((prev) => ({
                                    ...
                                    }, className: `` }), _jsx("div", { onMouseEnter: () => {
                                        if (!showStickerDetails.customizeCursor)
                                            setShowStickerDetails((prev) => ({ ...prev, hidePen: true }));
                                    }, onMouseLeave: () => {
                                        setShowStickerDetails((prev) => ({ ...prev, hidePen: false }));
                                    }, onClick: (e) => e.stopPropagation(), children: tools.pickColor && (_jsx(PickColor, { pick: (rgba) => {
                            ...
                            }, children: [_jsx(PaintRollerIcon, {}), _jsx("div", { onMouseEnter: () => {
                                        setShowStickerDetails((prev) => ({ ...prev, hidePen: true }));
                                    }, onMouseLeave: () => {
                                        setShowStickerDetails((prev) => ({ ...prev, hidePen: false }));
                                    }, onClick: (e) => e.stopPropagation(), children: bgColor.openPalette && (_jsx(PickColor, { pick: (rgba) => {
                                            setBgColor((prev) => ({
                                                ...prev,
                                                color: `rgba(${rgba.r}, ${rgba.g}, ${rgba.b}, ${rgba.a})`,
                                            }));
                                        } })) })] })] }) }), _jsx("div", { id: "canvas-container", className: "", style: { pointerEvents: "none", position: "relative" } }), _jsx("canvas", { style: {
                    // width: "100%",
                    // height: "100%",
                    // position: "relative",
                    zIndex: 999999,
