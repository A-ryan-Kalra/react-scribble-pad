...
function StickerEditor() {
    ...
    useEffect(() => {
        ...
        const handleMouseDown = (event) => {
            ...
            if (target.classList.contains("dynamic-input") ||
                target?.parentNode?.classList.contains("li-box") ||
    ...
    return (showInput && (_jsx("form", { onSubmit: handleInput, children: _jsx("input", { onKeyDown: (e) => {
                if (e.key === "Escape") {
                    setShowInput(false);
                    setInput("");
                }
            ...
            }, type: "text", value: input, className: "sticker-editor" }) })));
}
